...
class CreateReplishmentHistoryTableWithProductName extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sm_all_replishment_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sm_all_replishment_history');
    }
}
